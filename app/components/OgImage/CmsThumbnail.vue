...
<template>
  <div
    class="w-full grid justify-between relative h-full p-10 bg-stone-950"
    data-theme="dark"
  >
    ...
    <div>
      <div class="text-3xl flex-wrap text-stone-500 line-clamp-3 overflow-hidden grow">
        {{ description ? removeInvalidChars(description) : '' }}
      </div>
    </div>
    <div class="flex flex-wrap gap-6 text-3xl justify-between items-start text-stone-600 w-full">
