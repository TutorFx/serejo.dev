...
onMounted(() => {
  ...
  tl.to(starOneRef.value, { scale: .1, repeat: -1, duration: 3, ease: "power5.inOut", yoyo: true })
  .to(starTwoRef.value, { scale: .1, repeat: -1, duration: 3, ease: "power5.inOut", yoyo: true });
...
<template>
  <div class="overflow-hidden rounded-t-3xl [view-transition-name:hero]">
    <div class="relative pt-6">
      <div class="-z-[1] absolute left-[50%] bottom-[50%]" ref="itemOneRef">
      ...
      <div class="-z-[1] absolute left-[90%] bottom-[90%]" ref="itemTwoRef">
        <div class="max-w-0 max-h-0">
          <div
      ...
      <div class="-z-[1] absolute left-[0%] bottom-[10%]" ref="itemThreeRef">
        <div class="max-w-0 max-h-0">
          <div
      ...
      <div class="-z-[1] absolute right-[0%] bottom-[25%]" ref="itemFourRef">
        <div class="max-w-0 max-h-0">
          <div
      ...
      <div class="-z-[1] absolute left-[0%] top-[10%]" ref="itemFiveRef">
        <div class="max-w-0 max-h-0">
          <div
        ...
        <div class="grid items-center justify-center py-24 md:py-32 lg:py-48">
          <div class="relative">
            <div class="absolute -right-[0%] -top-[10%]">
              <div class="max-w-0 max-h-0" ref="starOneRef">
                <Icon
            ...
            <div class="absolute left-[50%] -bottom-[20%]">
              <div class="max-w-0 max-h-0" ref="starTwoRef">
                <SparkleOutline
    ...
    <div>
      ...
      <div class="relative">
        <div class="absolute z-[-2] top-0 bg-base-100 inset-x-[-100%] blur-2xl bottom-[-100%]" />
