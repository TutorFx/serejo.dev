...
<template>
  <div v-show="cursor" class="width-screen height-screen pointer-events-none fixed inset-0 z-[5000]">
    <div ref="cursor" class="bg-primary/30 h-6 w-6 flex items-center justify-center rounded-full backdrop-blur-sm">
      <ClientOnly>
